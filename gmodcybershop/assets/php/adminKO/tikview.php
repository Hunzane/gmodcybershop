...
<div class="replyct">
    ...
    <div class="btn-1" onclick="atiksendmsg('<?php echo $tikid; ?>')"><div class="btn-1-1"><i class="fas fa-comment-alt"></i></div></div>
    <div class="btn-2" onclick="atikview('<?php echo $tikid; ?>')"><div class="btn-2-1"><i class="fas fa-sync"></i></div>
</div>
    ...
    <?php
        ...
        if($tikmsgauthor == $uid){ ?>
            ...
            <div class="msgau">
                ...
                <div class="msgau-2"><div style="color: red;"><div style="float: right;"><?php echo $tikmsgdate; ?></div><?php echo $ulogin; ?></div><?php echo preg_replace( "#\r?\n#", "<br />", $tikmsgmessage ); ?></div>
            </div>
        ...
        <?php } else { ?>
            ...
            <div class="msgad">
                <div class="msgau-2" style="text-align: left;"><div style="color: white; float: left;"><?php echo $timl; ?></div><div style="float: right;"><?php echo $tikmsgdate; ?></div><br><?php echo preg_replace( "#\r?\n#", "<br />", $tikmsgmessage ); ?></div>
